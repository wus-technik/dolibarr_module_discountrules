...
//			);
	...
	public function init($options='')
	{
		...
		$extrafields->addExtraField('discountrules_min_markup_margin_percent', 'DiscountRulesMinMarkupMarginPercent', 'double', 100, '24,2', 'societe', 0, 0, '', array ( 'options' => array ( '' => NULL, ), ), 1, '', 'get_class($object) == \'Societe\' && !empty($object->client) ? 1:0', '', '', 0, 'discountrules@discountrules', 1, 0, '0', array ( 'css' => '', 'cssview' => '', 'csslist' => '', ));
